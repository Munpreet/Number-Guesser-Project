...
echo "I'm going to think of numbers between 1 and 10. Do you think you can guess correctly in the number guesser game?\n";
...
echo "\nAfter $play_count rounds, here are some interesting facts about your guessing:\nYou guessed the number correctly $percent_correct% of the time.\n";
